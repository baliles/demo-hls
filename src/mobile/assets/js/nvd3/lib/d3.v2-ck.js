(function() {
    ...
    function L(e, t) {
        ...
        if (arguments.length < 1) {
            e = 1;
            n = t / 4;
        } else n = t / (2 * Math.PI) * Math.asin(1 / e);
        return function(r) {
    ...
    function P(e) {
        ...
        this.rotate = (r ? Math.atan2(t[1], t[0]) : Math.atan2(-n[0], n[1])) * fs;
    ...
    function W(e, t, n) {
        ...
        if (a = hs.get(e)) return t(a.r, a.g, a.b);
    ...
    function G(e, t, n) {
        function r(e) {
            ...
            return e < 60 ? s + (o - s) * e / 60 : e < 180 ? o : e < 240 ? s + (o - s) * (240 - e) / 60 : s;
        }
        function i(e) {
    ...
    function rt(e, t, n) {
        ...
        r = st(r) * vs;
        s = st(s) * ms;
        return R(ut(3.2404542 * i - 1.5371385 * r - .4985314 * s), ut(-0.969266 * i + 1.8760108 * r + .041556 * s), ut(.0556434 * i - .2040259 * r + 1.0572252 * s));
    }
    function it(e, t, n) {
    ...
    function ct(e, t) {
        ...
        e = d3.ns.qualify(e);
        return t == null ? e.local ? r : n : typeof t == "function" ? e.local ? u : o : e.local ? s : i;
    }
    function ht(e) {
    ...
    function wt(e, t, n) {
        function r() {
            var t = this[s];
            if (t) {
                this.removeEventListener(e, t, t.$);
                delete this[s];
            }
        }
        function i() {
    ...
    function xt(e, t, n) {
        ...
        e.tween = function(t, n) {
            if (arguments.length < 2) return i.get(t);
            n == null ? i.remove(t) : i.set(t, n);
            return e;
        };
        e.ease = function(t) {
            if (!arguments.length) return o;
            o = typeof t == "function" ? t : d3.ease.apply(d3, arguments);
            return e;
        };
        e.each = function(t, n) {
            if (arguments.length < 2) return Tt.call(e, t);
            s.on(t, n);
            return e;
        };
        d3.timer(function(r) {
            return Et(e, function(e, u, a) {
                ...
                function c() {
                    --v.count || delete e.__transition__;
                    return 1;
                }
    ...
    function Lt() {
        ...
        while (t) if (t.flush) t = e ? e.next = t.next : Hs = t.next; else {
    ...
    function rn(e) {
        function t(t) {
            ...
            while (++c < h) if (i.call(this, p = t[c], c)) l.push([ +d.call(this, p, c), +v.call(this, p, c) ]); else if (l.length) {
                o();
                l = [];
            }
            l.length && o();
        ...
        t.interpolate = function(e) {
            ...
            typeof e == "function" ? a = s = e : a = (s = $s.get(e) || un).key;
            return t;
        };
    ...
    function kn(e) {
        function t(t) {
            ...
            while (++m < g) if (a.call(this, y = t[m], m)) {
        ...
        t.interpolate = function(e) {
            ...
            typeof e == "function" ? l = f = e : l = (f = $s.get(e) || un).key;
            c = f.reverse || f;
            h = f.closed ? "M" : "L";
            return t;
        };
        ...
        n.parseRows = function(e, t) {
            function n() {
                ...
                if (e.charCodeAt(t) === 34) {
                    ...
                    return e.substring(t + 1, n).replace(/""/g, '"');
                }
                var a = s.exec(e);
                if (a) {
                    l = a[0].charCodeAt(0) !== u;
                    return e.substring(t, a.index);
                }
    ...
    function ei() {
        ...
        e.distance = function() {
            p == null && (d = 1 / Math.sin(p = Math.acos(Math.max(-1, Math.min(1, i * l + r * f * Math.cos(u - t))))));
            return p;
        };
        e.source = function(u) {
    ...
    function Bi(e, t, n) {
        ...
        r.domain = function(t) {
            if (!arguments.length) return e.domain().map(Fi);
            e.domain(t);
            return r;
        };
        r.nice = function(e) {
        ...
        return d3.rebind(r, e, "range", "rangeRound", "interpolate", "clamp");
    }
    function ji(e) {
        var t = e[0], n = e[e.length - 1];
        return t < n ? [ t, n ] : [ n, t ];
    ...
    d3.split = function(e, t) {
        ...
        while (++s < o) if (t.call(r, i = e[s], s)) r = []; else {
            r.length || n.push(r);
            r.push(i);
        }
        return n;
    ...
    d3.formatPrefix = function(e, t) {
        ...
        if (e) {
            ...
            n = Math.max(-24, Math.min(24, Math.floor((n <= 0 ? n + 1 : n - 1) / 3) * 3));
        }
        return rs[8 + n / 3];
    };
    ...
    d3.ease = function(e) {
        ...
        n = us.get(n) || os;
        r = as.get(r) || x;
        return w(r(n.apply(null, Array.prototype.slice.call(arguments, 1))));
    };
    d3.event = null;
    ...
    d3.interpolateTransform = function(e, t) {
        ...
        } else a[0] || a[1] ? n.push("translate(" + a + ")") : n.push("");
        if (f != l) {
        ...
        } else (d[0] != 1 || d[1] != 1) && n.push(n.pop() + "scale(" + d + ")");
        i = r.length;
        return function(e) {
            var t = -1, s;
    ...
    U.prototype.brighter = function(e) {
        ...
        if (!t && !n && !r) return R(i, i, i);
        t && t < i && (t = i);
        n && n < i && (n = i);
        r && r < i && (r = i);
        return R(Math.min(255, Math.floor(t / e)), Math.min(255, Math.floor(n / e)), Math.min(255, Math.floor(r / e)));
    };
    U.prototype.darker = function(e) {
        e = Math.pow(.7, arguments.length ? e : 1);
        return R(Math.floor(e * this.r), Math.floor(e * this.g), Math.floor(e * this.b));
    };
    ...
    Q.prototype.brighter = function(e) {
        e = Math.pow(.7, arguments.length ? e : 1);
        return K(this.h, this.s, this.l / e);
    };
    Q.prototype.darker = function(e) {
        e = Math.pow(.7, arguments.length ? e : 1);
        return K(this.h, this.s, e * this.l);
    };
    ...
    Ss.append = function(e) {
        ...
        e = d3.ns.qualify(e);
        return this.select(e.local ? n : t);
    };
    Ss.insert = function(e, t) {
        ...
        e = d3.ns.qualify(e);
        return this.select(e.local ? r : n);
    };
    Ss.remove = function() {
    ...
    Ns.select = function(e) {
        ...
        for (var s = -1, o = this.length; ++s < o; ) {
            t.push(n = []);
            for (var u = this[s], a = -1, f = u.length; ++a < f; ) if ((i = u[a]) && (r = e.call(i.node, i.node.__data__, a))) {
    ...
    Ns.styleTween = function(e, t, n) {
        ...
        return this.tween("style." + e, function(r, i) {
    ...
    var Fs = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
        setTimeout(e, 17);
    };
    d3.mouse = function(e) {
        return At(e, _());
    ...
    d3.svg.diagonal = function() {
        function e(e, i) {
            var s = t.call(this, e, i), o = n.call(this, e, i), u = (s.y + o.y) / 2, a = [ s, {
                x: s.x,
                y: u
            }, {
                x: o.x,
    ...
    d3.svg.brush = function() {
        function e(s) {
            s.each(function() {
                ...
                c.enter().append("g").attr("class", function(e) {
                    return "resize " + e;
        ...
        function i() {
            ...
            function h() {
                ...
                if (!S) if (d3.event.altKey) {
                    x || (x = [ (f[0][0] + f[1][0]) / 2, (f[0][1] + f[1][1]) / 2 ]);
                    T[0] = f[+(e[0] < x[0])][0];
                    T[1] = f[+(e[1] < x[1])][1];
                } else x = null;
                if (w && p(e, o, 0)) {
        ...
        e.extent = function(t) {
            ...
            if (!arguments.length) {
                ...
                return o && u ? [ [ n, i ], [ r, s ] ] : o ? [ n, r ] : u && [ i, s ];
            }
            l = [ [ 0, 0 ], [ 0, 0 ] ];
            if (o) {
                n = t[0], r = t[1];
    ...
    d3.layout.force = function() {
        ...
        n.drag = function() {
            o || (o = d3.behavior.drag().origin(i).on("dragstart", Xn).on("drag", t).on("dragend", Vn));
            this.on("mouseover.force", $n).on("mouseout.force", Jn).call(o);
        };
        return d3.rebind(n, r, "on");
    };
    ...
    d3.layout.stack = function() {
        ...
        e.order = function(t) {
            if (!arguments.length) return n;
            n = typeof t == "function" ? t : so.get(t) || tr;
            return e;
        };
        e.offset = function(t) {
            if (!arguments.length) return r;
            r = typeof t == "function" ? t : oo.get(t) || nr;
            return e;
        };
        e.x = function(t) {
            if (!arguments.length) return o;
    ...
    d3.layout.treemap = function() {
        ...
        function r(e, t) {
            ...
            n *= n;
            t *= t;
            return n ? Math.max(t * i * p / n, n / (t * s * p)) : Infinity;
        }
        function i(e, t, n, r) {
        ...
        s.padding = function(e) {
            ...
            if (!arguments.length) return f;
            var r;
            l = (f = e) == null ? Fr : (r = typeof e) === "function" ? t : r === "number" ? (e = [ e, e, e, e ], n) : n;
            return s;
        };
        s.round = function(e) {
            if (!arguments.length) return u != Number;
            u = e ? Math.round : Number;
            return s;
        };
        s.sticky = function(e) {
            if (!arguments.length) return c;
    ...
    d3.geo.bonne = function() {
        ...
        e.parallel = function(t) {
            if (!arguments.length) return s / ao;
            o = 1 / Math.tan(s = t * ao);
            return e;
        };
        e.origin = function(t) {
            if (!arguments.length) return [ r / ao, i / ao ];
            r = t[0] * ao;
            i = t[1] * ao;
            return e;
        };
        ...
        return e.origin([ 0, 0 ]).parallel(45);
    };
    ...
    d3.geo.circle = function() {
        ...
        function n(e) {
            ...
            while (++t < n) {
                ...
                if (c < u) {
                    ...
                    o = f;
                    if (!s && i.length) {
                        i.push(ti(i[i.length - 1], o)((u - l) / (c - l)));
                        s = o;
                    }
                }
                l = c;
        ...
        return d3.rebind(e, a, "precision");
    };
    ...
    d3.geom.hull = function(e) {
        ...
        for (s = 1; s < n; ++s) {
            ...
            if (d == r[s].angle) {
                ...
                l = e[o][0] - e[u][0];
                c = e[o][1] - e[u][1];
                if (a * a + f * f >= l * l + c * c) r[s].index = -1; else {
                    r[h].index = -1;
                    d = r[s].angle;
                    h = s;
                    p = o;
        ...
        i.push(u);
        for (s = 0, o = 0; s < 2; ++o) if (r[o].index !== -1) {
            i.push(r[o].index);
            s++;
        }
        v = i.length;
            ...
            while (++r < i) {
                ...
                while (++s < o) {
                    ...
                    if (ii(l, u, a)) {
                        ...
                        t.push(l);
                    } else ii(f, u, a) && t.push(si(f, l, u, a));
                    f = l;
                }
                u = a;
            }
    ...
    d3.geom.quadtree = function(e, t, n, r, i) {
        function s(e, t, n, r, i, s) {
            ...
            if (e.leaf) {
                var u = e.point;
                if (u) if (Math.abs(u.x - t.x) + Math.abs(u.y - t.y) < .01) o(e, t, n, r, i, s); else {
                    e.point = null;
                    o(e, u, n, r, i, s);
                    o(e, t, n, r, i, s);
                } else e.point = t;
        ...
        if (arguments.length < 5) if (arguments.length === 3) {
            i = r = n;
            n = t;
        } else {
            t = n = Infinity;
    ...
    d3.time.format = function(e) {
        function t(t) {
            var r = [], i = -1, s = 0, o, u;
            while (++i < n) if (e.charCodeAt(i) == 37) {
