...
$.fn.bic_calendar = function(options) {
    ...
    this.each(function(){
        ...
        var calendario;
        var capaDiasMes;
        var capaTextoMesAnoActual = $('<span></span>');
        ...
        function mostrarCalendario(){
            ...
            capaDiasMes = $('<table class="diasmes table">');
            ...
            var botonMesSiguiente = $('<a href="#"><i class="fa fa-angle-right"></i></a>');
            ...
            var botonMesAnterior = $('<a href="#"><i class="fa fa-angle-left"></i> </a>');
            ...
            var capaTextoMesAno = $('<div class="calendar-head "></div>');
            var capaTextoMesAnoControl = $('<h4 class="text-center"></h4>');
